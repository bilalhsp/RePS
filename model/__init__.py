...
def get_model(name, **kwargs):
    if name == 'ddpm':
        return create_model(**kwargs['model_config'])
    elif name == 'ldm':
        return LatentDMWrapper(load_model_from_config(kwargs['ldm_config'], kwargs['diffusion_path']))
...
#     # return __MODEL__[name](**kwargs).model.model    # to get the unet object
#     return __MODEL__[name](**kwargs)    # 02-25-26: changint to get the full object
